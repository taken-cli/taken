...
@pytest.mark.anyio
async def test_paths__no_env_var__defaults_to_home_taken(monkeypatch: pytest.MonkeyPatch):
    # Arrange
...
@pytest.mark.anyio
async def test_paths__env_var_set__uses_env_var(monkeypatch: pytest.MonkeyPatch, tmp_path: Path):
    # Arrange
