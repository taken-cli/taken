---
description: Integration testing conventions — pytest patterns, fixtures, CLI invocation, assertions, and naming
globs: "tests/**/*.py"
alwaysApply: true
---
...
```python
async def test_foo_not_initialized(taken_home: Path, cli_runner: CliRunner) -> None:
